...
export const WeeklySnapshotsSchema = z.object({
  ...
  Effective_Donors_1Month: z.number().int(),
  Volunteers_1Month: z.number().int(),
  Volunteer_Donors_1Month: z.number().int(),
  New_People_7Days: z.number().int(),
  Inactive_People_7Days: z.number().int(),
  Inactive_People_1Month: z.number().int(),
  New_Donors_7Days: z.number().int(),
  New_Volunteers_7Days: z.number().int(),
  Inactive_Donors_1Month: z.number().int(),
  All_Adults: z.number().int(),
  Active_Adults_7Days: z.number().int(),
  Active_Adults_1Month: z.number().int(),
  Active_Adults_3Month: z.number().int(),
  Adult_Donors_1Month: z.number().int(),
  Adult_Volunteers_1Month: z.number().int(),
  Active_Placed_Volunteer_Snap: z.number().int().nullable(),
  Adult_Volunteer_Donors_1Month: z.number().int(),
  New_Adults_7Days: z.number().int(),
  Inactive_Adults_7Days: z.number().int(),
  Inactive_Adults_1Month: z.number().int(),
  New_Adult_Donors_7Days: z.number().int(),
  New_Adult_Volunteers_7Days: z.number().int(),
  Inactive_Adult_Donors_1Month: z.number().int(),
  All_Households: z.number().int(),
  Active_Households_7Days: z.number().int(),
  Active_Households_1Month: z.number().int(),
  Active_Households_3Month: z.number().int(),
  ...
  Inactive_Households_7Days: z.number().int(),
  Inactive_Households_1Month: z.number().int(),
  New_Donor_Households_7Days: z.number().int(),
  New_Volunteer_Households_7Days: z.number().int(),
  Inactive_Donor_Households_1Month: z.number().int(),
  ...
  App_Installs: z.number().int().nullable(),
  App_Activity: z.number().int().nullable(),
});
