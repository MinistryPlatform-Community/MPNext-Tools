...
export const ContactsSchema = z.object({
  ...
  Office_Extension: z.string().max(25).nullable(),
  ...
  MySpace_Account: z.string().max(50).nullable(),
  IM_Account: z.string().max(50).nullable(),
  LinkedIn_Account: z.string().max(50).nullable(),
