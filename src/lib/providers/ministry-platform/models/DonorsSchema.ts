...
export const DonorsSchema = z.object({
  ...
  AUTHNet_ProfileID: z.number().int().nullable(),
  AUTHNet_Event_ProfileID: z.number().int().nullable(),
  Confirmed_Mobile_Giving_Number: z.string().max(50).nullable(),
  Confirmed_Mobile_Date: z.string().datetime().nullable(),
